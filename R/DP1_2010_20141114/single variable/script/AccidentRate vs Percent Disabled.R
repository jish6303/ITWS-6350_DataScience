...
plot(data10$Percent.Disabled, xlab= "Percent never married",rate, ylab= "Accident Rate", main="Accident Rate vs.Percentage Disabled")
model<-lm(rate~data10$Percent.Disabled)
