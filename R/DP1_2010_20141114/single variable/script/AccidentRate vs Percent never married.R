...
plot(data10$Percent.Never.Married, xlab= "Percent never married",rate, ylab= "Accident Rate", main="Accident Rate vs.Percentage of Population Never Married")
model<-lm(rate~data10$Percent.Never.Married)
