...
Old00P<-DP2000$X85.years.and.over/DP2000$Total.population
plot(Old00P,FatRat00, xlab= "Aged Percent%", ylab= "Accident Rate", main="Accident Rate vs. 85-and-older Percentage")
